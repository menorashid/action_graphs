...
from graph_multi_video_cog import Graph_Multi_Video as GCO
...
class Network:
    def __init__(self,
        ...
        self.model = Graph_Multi_Video(n_classes, deno, in_out,feat_dim, graph_size, method, sparsify, non_lin, aft_nonlin,sigmoid, layer_bef, graph_sum, background, just_graph, feat_ret, smax)
        print self.model
    ...
    def get_lr_list(self, lr):
        ...
        modules += [self.model.gco.graph_layer, self.model.gco.last_graph]
