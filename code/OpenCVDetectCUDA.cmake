...
if(CUDA_FOUND)
  ...
  set(_generations  "Kepler" "Maxwell" "Pascal" "Volta")
  ...
  message("cuda arch bin ${__cuda_arch_bin}")
  ...
  message("cuda arch bin ${CUDA_ARCH_BIN}")
  ...
  foreach(ARCH IN LISTS ARCH_LIST)
    ...
    elseif (ARCH MATCHES "21")
      message("ARCH ${ARCH}")
    
    elseif(ARCH MATCHES "([0-9]+)\\(([0-9]+)\\)")
